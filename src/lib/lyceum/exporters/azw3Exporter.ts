    ...
    return {
      ...
      report: {
        ...
        stats: {
          ...
          extraDataFlags: azw3.stats.extraDataFlags,
          estimatedLocationCount: validation.metadata.estimatedLocationCount || 0,
          skeletonCount: azw3.stats.skeletonCount,
          fragmentCount: azw3.stats.fragmentCount,
          maxFragmentLength: azw3.stats.maxFragmentLength,
          maxTocDepth: azw3.stats.maxTocDepth,
          tbsRecordCount: azw3.stats.tbsRecordCount,
          tbsByteCount: azw3.stats.tbsByteCount,
          textPaddingBytes: azw3.stats.textPaddingBytes,
          rawInternalHrefCount: validation.metadata.rawInternalHrefCount || 0,
          kindlePositionLinkCount: validation.metadata.kindlePositionLinkCount || 0,
          ...
          datpRecord: azw3.stats.datpRecord,
          flisRecord: azw3.stats.flisRecord,
          fcisRecord: azw3.stats.fcisRecord,
          ...
          validatedImageResourceCount: validation.metadata.imageResourceCount || 0,
          invalidImageResourceCount: validation.metadata.invalidImageResourceCount || 0,
          kindleEmbedReferenceCount: validation.metadata.kindleEmbedReferenceCount || 0,
          coverImageOffset: validation.metadata.coverImageOffset ?? -1,
          thumbnailImageOffset: validation.metadata.thumbnailImageOffset ?? -1,
          fidelityMode: "kf8-semantic",
          ...
          firmwareProfile: prepared.firmwareProfile,
          unresolvedInternalLinkCount: azw3.stats.unresolvedInternalLinkCount,
        },
      },
    };
  }
